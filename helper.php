...
Use:
    ...
    Для преобразования используется файл php с содержащимся внутри него массивом настроек
    для каждого столбца csv файла.
    Примеры можно посмотреть в tests/testingFiles/ там файлы сгруппированы по смыслу.
Usage:
